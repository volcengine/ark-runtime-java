...
public class MessagesContextManagementKeepAll {
  ...
  public static class Builder {
    ...
    private MessagesContextManagementKeepAll instance;

    public Builder() {
      this(new MessagesContextManagementKeepAll());
    }

    protected Builder(MessagesContextManagementKeepAll instance) {
    ...
    /**
    * returns a built MessagesContextManagementKeepAll instance.
    *
    * The builder is not reusable.
    */
    public MessagesContextManagementKeepAll build() {
      try {
  ...
  */
  public static MessagesContextManagementKeepAll.Builder builder() {
