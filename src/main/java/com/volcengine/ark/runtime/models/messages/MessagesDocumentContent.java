...
public class MessagesDocumentContent {
  ...
  public static MessagesDocumentContent ofList(java.util.List<MessagesContentPart> value) {
    return new MessagesDocumentContent(value);
  }
  ...
  public static class Deserializer extends JsonDeserializer<MessagesDocumentContent> {
    @Override
