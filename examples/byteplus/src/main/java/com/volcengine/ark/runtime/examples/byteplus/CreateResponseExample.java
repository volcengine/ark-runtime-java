...
public class CreateResponseExample {
    ...
    private static final String modelName = "seed-2-0-lite-260428";
    ...
    public static void main(String[] args) {
        ...
        ArkService service = ArkService.byteplus().dispatcher(dispatcher).timeout(Duration.ofHours(1)).connectionPool(connectionPool).apiKey(apiKey).build();
        ...
        try {
            Map<String, String> mcpHeaders = new HashMap<>();
            mcpHeaders.put("ark-beta-mcp", "true");
            service.streamResponse(request5, mcpHeaders)
                    .doOnError(Throwable::printStackTrace)
                    .blockingForEach(
                            CreateResponseExample::printStreamEvent
                    );
